...
const MovieForm = () => {
  ...
  const releaseYears = Array.from({ length: 20 }, (_, i) =>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-700 border-2 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-700 border-2 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-gray-700 border-2 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors ${
                ...
                <div>
                  ...
                  <input
                    ...
                    max="300"
                    placeholder="e.g., 120"
                    className={`w-full px-4 py-3 bg-gray-700 border-2 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-colors ${
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-gray-700 border-2 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 bg-gray-700 border-2 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors resize-none ${
            ...
            <div className="mt-8 pt-6 border-t border-gray-700">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">✓</span>
                  <span>
                    Duration should be in minutes (e.g., 120 for 2 hours)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">✓</span>
                  <span>
                    Provide a descriptive summary of at least 10 characters
                  </span>
                </li>
              </ul>
            </div>
