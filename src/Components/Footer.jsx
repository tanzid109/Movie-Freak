        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Your ultimate destination for discovering, rating, and organizing
              your favorite movies. Explore thousands of films from all genres
              and eras.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Movies", "Favorites", "Add Movie", "Feedback"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
