...
const Form = () => {
    ...
    const onSubmit = async (data) => {
        ...
        Swal.fire({
            ...
            customClass: {
                popup: 'rounded-2xl',
                title: 'text-gradient bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent'
            }
        });
    ...
    const renderStars = () => {
        return [1, 2, 3, 4, 5].map((star) => (
            ...
            >
                <Star
                    className={`w-10 h-10 ${star <= (hoveredRating || selectedRating || watch("rating") || 0)
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-black">
          ...
          bg-clip-text text-transparent mb-4">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                >
                                    ...
                                    <div className="flex justify-between mt-2">
                                        ...
                                        <span className={`text-sm ${(watch("message")?.length || 0) > 450 ? 'text-red-400' : 'text-gray-400'
                                            }`}>
                ...
                hover:scale-105 transition duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                ...
                                {!Object.keys(errors).length && watch("name") && watch("email") && watch("message") && (
                                    <motion.div
                    ...
                    >
                        ...
                        <p className="mt-1">All responses are confidential and used to improve our services.</p>
                    </motion.div>
                </div>
            </div>
        </div>
