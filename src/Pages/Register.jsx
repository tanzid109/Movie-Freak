...
import { FaEye, FaEyeSlash, FaUser, FaEnvelope, FaCamera, FaLock, FaCheck } from "react-icons/fa";
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pl-12 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${error.name ? 'border-red-500' : 'border-gray-600'
                                            }`}
                                        disabled={isLoading}
                                    />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pl-12 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${error.email ? 'border-red-500' : 'border-gray-600'
                                            }`}
                                        disabled={isLoading}
                                    />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pl-12 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${error.photo ? 'border-red-500' : 'border-gray-600'
                                            }`}
                                        disabled={isLoading}
                                    />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pl-12 pr-12 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${error.password ? 'border-red-500' : 'border-gray-600'
                                            }`}
                                        disabled={isLoading}
                                    />
                                    ...
                                    <div className="space-y-1">
                                        {[
                                            ...
                                            <div key={req.key} className="flex items-center gap-2">
                                                <div className={`w-4 h-4 rounded-full flex items-center justify-center ${passwordRequirements[req.key]
                                                        ? 'bg-green-500'
                                                        : 'bg-gray-700'
                                                    }`}>
                                                ...
                                                <span className={`text-sm ${passwordRequirements[req.key]
                                                        ? 'text-green-400'
                                                        : 'text-gray-500'
                                                    }`}>
                                                    {req.text}
